...
- [PlayerLocator](PlayerLocator) *in-depth url*
...
Find a person in a lobby by showing you an arrow towards their location.

#### Main Features

- An arrow towards a selected player
...
The build process was taken from the GPL licensed repo https://github.com/kafeijao/Kafe_CVR_Mods/
